...
public class RestaurantTest {
    ...
    @Autowired
    private RestaurantKeywordRepository restaurantKeywordRepository;
...
//        });
    ...
    {
        List<Object[]> results = restaurantKeywordRepository.findRestaurantAndScoreByRestaurantKeyword("가성비");
